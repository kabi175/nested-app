...
export default function RedeemVerificationScreen() {
  const { orderIds, fundName, fundId, goalId } = useLocalSearchParams<{
    orderIds: string;
    fundName?: string;
    fundId?: string;
    goalId?: string;
              ...
              <>
                <View style={styles.otpContainer}>
                  <OtpInput
                    ...
                    disabled={isVerifying || isProcessingRedeem}
                  />
                </View>
                ...
                <View style={styles.buttonContainer}>
                  <TouchableOpacity
                    ...
                    activeOpacity={0.8}
                  >
                    {!isVerifying && !isProcessingRedeem && (
                ...
                {/* Redeem Details Section */}
                <View style={styles.redeemDetailsContainer}>
                  <View style={styles.redeemDetailsRow}>
                    <View style={styles.redeemDetailsLeft}>
                      <Text category="s2" style={styles.redeemDetailsLabel}>
                        Fund Name
                      </Text>
                    </View>
                    <View style={styles.redeemDetailsRight}>
                      <Text category="s1" style={styles.redeemDetailsValue}>
                        {fundName || "N/A"}
                      </Text>
                    </View>
                  </View>
